...
-- CreateEnum
CREATE TYPE "ActivityEntityType" AS ENUM ('issue', 'project', 'cycle', 'workspace', 'comment', 'member', 'label');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('created', 'updated', 'deleted', 'status_changed', 'priority_changed', 'assignee_changed', 'project_changed', 'cycle_changed', 'estimate_changed', 'due_date_changed', 'title_changed', 'description_changed', 'label_added', 'label_removed', 'commented', 'comment_updated', 'comment_deleted', 'relation_added', 'relation_removed', 'attachment_added', 'attachment_removed', 'parent_changed', 'member_added', 'member_removed', 'role_changed', 'archived');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('issue_assigned', 'issue_unassigned', 'issue_status_changed', 'issue_comment', 'comment_mention', 'issue_priority_changed', 'issue_due_soon', 'workspace_invite');
...
CREATE TABLE "Workspace" (
    ...
    "pendingInvites" JSONB NOT NULL DEFAULT '[]',
...
CREATE TABLE "Issue" (
    ...
    "boardOrder" DOUBLE PRECISION NOT NULL DEFAULT 1000,
    "projectId" TEXT,
    "cycleId" TEXT,
    "assigneeId" TEXT,
...
CREATE TABLE "IssueRelation" (
    ...
    "type" "IssueRelationType" NOT NULL DEFAULT 'related',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
